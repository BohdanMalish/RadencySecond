...
const Summary = () => {
  ...
  return (
    <div className={'todo-info-notes todo-wrapper'}>
      <div className={'header-line-info'}>
        <ul className={'header-line header-line-info-lst'}>
          <li>Category</li>
        </ul>
      ...
      <div className={'header-line-info header-line-info-item'}>
        <img src="./media/images/thoughts.png" alt=""></img>
        <ul className={'header-line header-line-info-lst'}>
          <li>Random Thoughts</li>
        </ul>
        <ul className={'Status-notes  Status-notes-items'}>
